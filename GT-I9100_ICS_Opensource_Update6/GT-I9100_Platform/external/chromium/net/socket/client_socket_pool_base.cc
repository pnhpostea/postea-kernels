...
// SAMSUNG CHANGE: changed error code ERR_TIME_OUT to ERR_CONNECTION_FAILED, for not displaying connection fail popup by connection timeout.
//  NotifyDelegateOfCompletion(ERR_TIMED_OUT);
  NotifyDelegateOfCompletion(ERR_CONNECTION_FAILED);
// SAMSUNG CHANGE
}
