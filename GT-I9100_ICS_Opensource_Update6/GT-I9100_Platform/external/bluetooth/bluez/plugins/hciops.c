...
//	DBG("hci%d dba %s", index, addr);
	DBG("hci%d dba ", index);   // log checker (BT)
...
//	DBG("hci%d dba %s type %d", index, da, evt->key_type);
	DBG("hci%d dba  type %d", index, evt->key_type);   // log checker (BT)
...
static int hciops_confirm_reply(int index, bdaddr_t *bdaddr, gboolean success)
{
	...
	DBG("hci%d dba  success %d", index, success);   // log checker (BT)
...
//	DBG("hci%d IO capability request for %s", index, da);
	DBG("hci%d IO capability request for ", index);   // log checker (BT)
...
//	DBG("hci%d IO capability response from %s", index, da);
	DBG("hci%d IO capability response from ", index);   // log checker (BT)
...
//	DBG("hci%d PIN request for %s", index, addr);
	DBG("hci%d PIN request for ", index);   // log checker (BT)
...
//	DBG("hci%d addr %s which %d timeout %d", index, addr, which, timeout);
	DBG("hci%d addr  which %d timeout %d", index, which, timeout);   // log checker (BT)
...
//	DBG("hci%d bdaddr %s", index, addr);
	DBG("hci%d bdaddr ", index);   // log checker (BT)
...
//	DBG("hci%d, addr %s, num_slots %d", index, bdaddr, num_slots);
	DBG("hci%d, addr, num_slots %d", index, num_slots);   // log checker (BT)
