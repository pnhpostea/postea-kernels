...
// Samsung Adding for multicolumn text selection - Begin
    int selectionTop(bool bMulticolumn = false) const;
// Samsung Adding for multicolumn text selection - End 
    int selectionBottom() const;
// Samsung Adding for multicolumn text selection - Begin
    int selectionHeight(bool bMulticolumn = false) const { return max(0, selectionBottom() - selectionTop(bMulticolumn)); }
// Samsung Adding for multicolumn text selection - End 
