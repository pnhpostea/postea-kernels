...
IntRect RenderText::localCaretRect(InlineBox* inlineBox, int caretOffset, int* extraWidthToEndOfLine,bool bMultiColumn)
{
...
// Samsung Adding for multicolumn text selection - begin
    int height = box->root()->selectionHeight(bMultiColumn);
    int top = box->root()->selectionTop(bMultiColumn);
// Samsung Adding for multicolumn text selection - End
